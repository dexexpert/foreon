...
export const PredictionWinBlock = () => {
  return (
    <>
      <ContainerLayout>
        <Box my={'2em'}  >
          ...
          {/*@ts-ignore*/}
          <Buttons color={''} bg={'linear-gradient(135deg, #00A9B7 -1.33%, #4C32F2 47.36%, #9F00BE 95.53%)'} my={'1em'}
                   w={'100%'} h={'52px'}>Redeem Winnings</Buttons>
