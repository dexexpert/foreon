    ...
    <>
      ...
      <ContainerLayout>
        <Box my={'2em'}>
          ...
          <Text weight={'bold'} size={'20px'} color={'#000'}>
            Choose a mode of funding your wallet
          </Text>
        </Box>
        ...
        <Box my={'2em'} px={'2em'}>
          <Box display={'flex'}
            ...
            <Box>
              <Text weight='bold' color='black' className={'duplicate'} size={'18px'}>Wallet</Text>
              <Text size={'10px'}>
                Deposit from cardano supported wallets desktop extension or mobile
                app such as Nami, Typhoo, Eternl
              </Text>
            </Box>
          </Box>
